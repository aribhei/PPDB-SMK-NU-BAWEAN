      ...
      <section className="relative overflow-hidden bg-white pt-16 pb-32">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center max-w-3xl mx-auto">
            ...
            >
              Bergabunglah bersama {settings?.namaSekolah || 'SMK NAHDLATUL ULAMA BAWEAN'}. Kami berkomitmen memberikan pendidikan yang terbaik dengan fasilitas modern dan tenaga pendidik profesional.
            </motion.p>
